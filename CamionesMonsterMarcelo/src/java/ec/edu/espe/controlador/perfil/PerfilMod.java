 ...
 * @author Marcelo
 */
@WebServlet(name = "PerfilMod", urlPatterns = {"/PerfilMod"})
public class PerfilMod extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet PefilMod</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet PefilMod at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        PerfilDAO.getInstance().eliminarPerfil(id);
       ...
       String codigo= request.getParameter("txtCodigo");
        ...
        try{
             if(!codigo.equals("")&&!descripcion.equals("")&&!observacion.equals(""))
                PerfilDAO.getInstance().editarPerfil(codigo, descripcion, observacion);
