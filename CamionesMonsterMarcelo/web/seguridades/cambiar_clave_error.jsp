                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="page-header">
                          ...
                          <form action="/CamionesMonsterMarcelo/LoginMod" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="txtContraVeri" id="txtContraVeri" class="form-control">
                            ...
                            <div class="form-group">
                                <label>Reingresar Contraseña Nueva</label>
                                <input type="password" name="txtContra1" class="form-control">
                                <span class="help-block"></span>
                            </div>
