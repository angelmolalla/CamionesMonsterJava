                ...
                <div class=row>
                    <div class=col-md-12>
                        <div class=page-header clearfix>
                           <p class=pull-left><h2 >Detalles del Perfil</h2></p>
                        ...
                        <form>
                            <table class='table table-bordered table-striped'>
                                ...
                                <p:forEach items="${perfiles}" var="x">
                                        ...
                                        <tr>      
                                            ...
                                            <td>   ${x.xeperObser} </td>              
                                            <td>                                      
                                                  <a href='/CamionesMonsterMarcelo/seguridades/editar_perfil.jsp?id=${x.xeperCodigo}' title='Modificar el Perfil' 
                                                   data-toggle='tooltip'><span class='glyphicon glyphicon-pencil'></span></a>
                                                <a href='/CamionesMonsterMarcelo/PerfilMod?id=${x.xeperCodigo}' onclick="return confirm('Seguro que deseas eliminar el item?');" title='Borrar' 
                            ...
                            <tr>
                                <td><input type="submit" class="btn btn-primary" value="Agregar"  formaction="/CamionesMonsterMarcelo/seguridades/agregar_perfil.jsp"></td>
