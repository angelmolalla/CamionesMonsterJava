                ...
                <div class=row>
                    <div class=col-md-12>
                        <div class=page-header clearfix>
                           <p class=pull-left><h2 >Detalles del Departamento</h2></p>
                        ...
                        <form>
                            <table class='table table-bordered table-striped'>
                                ...
                                <p:forEach items="${departamentos}" var="x">
                                        ...
                                        <tr>      
                                            ...
                                            <td>                                      
                                                  <a href='/CamionesMonsterMarcelo/personal/editar_departamento.jsp?id=${x.pedepCodigo}' title='Modificar Departamento' 
                                                   data-toggle='tooltip'><span class='glyphicon glyphicon-pencil'></span></a>                                    
                                                  <a href='/CamionesMonsterMarcelo/DepartamentoMod?txtId=${x.pedepCodigo}' onclick="return confirm('Seguro que deseas eliminar el item?');" title='Borrar' 
                            ...
                            <tr>
                                <td><input type="submit" class="btn btn-primary" value="Agregar"  formaction="/CamionesMonsterMarcelo/personal/agregar_departamento.jsp"></td>
