          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-12">
                ...
                <form action="/CamionesMonsterMarcelo/OpcionConst" method="post">           
                  <div class="form-group">
                    <label>Código del Sistema</label>
                    <input type="text" name="txtCodigoSistema" class="form-control">
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group" style="display: none;">
                    ...
                    <input type="text" name="txtSize" class="form-control" value="<%=request.getParameter("size")%>">
                    <span class="help-block"></span>
                  </div> 
