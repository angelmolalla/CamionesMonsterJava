            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form action="/CamionesMonsterMarcelo/UsuarioConst" method="post">           
                            <div class="form-group">
                                <label>Código Empleado</label>
                                <SELECT id="cmbEstadoCivil" NAME="cmbCodigoEmpleado" SIZE=1 class="form-control"> 
                                    <p:forEach items="${empleados}" var="x">

                                        <option value=${x.peempCodigo}>${x.peempCedula}</option>
