          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-12">
                ...
                <form action="/CamionesMonsterMarcelo/OpcionMod" method="post">           
                  <div class="form-group">
                    <label>Código Opcion</label>
                    ...
                    <input type="text" name="txtCodigoSistema" class="form-control" value="<%=request.getParameter("idSistema")%>">
                    <span class="help-block"></span>
                  </div>
