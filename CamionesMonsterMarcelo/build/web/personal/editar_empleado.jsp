        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="/CamionesMonsterMarcelo/EmpleadoMod" method="post">
                        ...
                        <div id="Personal" class="tabcontent">  
                             <div class="form-group">
                                ...
                                <input type="text" name="txtIdEmpleado" class="form-control" value="<%=request.getParameter("id") %>">
                        ...
                        <div class="form-group">
                                <label>Fecha  de Salida del Empleado</label>
                                <input type="date" name="txtDateSalida" class="form-control">
                                <span class="help-block"></span>
                            </div> 
                        </div>
                        ...
                        <a href="/CamionesMonsterMarcelo/EmpleadoMod" class="btn btn-default">Cancelar</a>
                    </form>
