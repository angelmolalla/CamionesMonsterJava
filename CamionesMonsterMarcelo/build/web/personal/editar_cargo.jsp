          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-12">
                ...
                <form action="/CamionesMonsterMarcelo/CargoMod" method="post">
                  <div class="form-group">
                    <label>Código Cargo</label>
                    <input type="text" name="txtId" class="form-control" value="<%=request.getParameter("id") %>">
                    <span class="help-block"></span>
                  </div>
                  <div class="form-group">
                    <label>Código Departamento</label>
                    <input type="text" name="txtIdDepartamento" class="form-control" value="<%=request.getParameter("idDepartamento") %>">
                    <span class="help-block"></span>
                  </div>
                  ...
                  <a href="/CamionesMonsterMarcelo/CargoConst" class="btn btn-default">Cancelar</a>
                </form>
              </div>
            </div>
          </div>
